...
LV_IMG_DECLARE(flag01);
LV_IMG_DECLARE(flag02);
LV_IMG_DECLARE(flag03);
LV_IMG_DECLARE(flag04);
LV_IMG_DECLARE(flag05);
LV_IMG_DECLARE(flag06);
LV_IMG_DECLARE(flag07);
LV_IMG_DECLARE(flag08);
...
static void draw_top(lv_obj_t *widget, lv_color_t cbuf[], const struct status_state *state) {
    ...
    // Draw connection status (this half's link to the other board)
